...
FIRST OF ALL ACTIVATE VIRTUALENV!!!

```
python3.7 -m venv faster_rcnn
source faster_rcnn/bin/activate

* Python 3.6
* torch 1.0 (pip install torch==1.0)
* torchvision 0.2.1 (pip install torchvision==0.2.1)
* tqdm
    ```
    $ pip install tqdm
    ```
